...
public class DateFormat4Sql  {
	 ...
	 */
	public  DateFormat4Sql  ymd(Date date) {
		
		this.sql = " DATE_FORMAT(?,'%Y-%m-%d') ";
		this.parameter = this.sdf.format(date);
		return this;
	}
	/**
	 * 年月日, 时间格式：MM-dd ;如 09-01.
	 */
	public  DateFormat4Sql  monthAndDay(Date date) {
		
		this.sql = " DATE_FORMAT(?,'%m-%d') ";
		this.parameter = this.sdf.format(date);
		return this;
	}
	/**
	 * 年月日, 时间格式：MM-dd ;如 09-01.
	 */
	public  DateFormat4Sql  monthAndDay(String formatdate) {
		
this.sql = " DATE_FORMAT(?,'%m-%d') ";
		
		try {
			this.sdf.parse(formatdate);
			this.parameter = formatdate;
			return this;
	...
	public  DateFormat4Sql  ymd(String formatdate) {
